...
SET FileDate = 'c:\Anchor\QuickbooksExcel\' + convert(varchar,(dateadd(week, (((DATEDIFF(dd, '19700101', getdate())/7)-((mod((DATEDIFF(dd, '19700101', getdate())/7),2))))), '19700101')+3), 112) + '_Anchor_Pay_Job_Detail.csv';
