...
SET FileDate = 'c:\Anchor\QuickbooksExcel\' + convert(varchar,(dateadd(week, (DATEDIFF(dd, '19700101', getdate())/7), '19700101') - (datepart(dw, getdate())-3)), 112) + '_Anchor_Pay_Adj_Job_Summary.csv';
